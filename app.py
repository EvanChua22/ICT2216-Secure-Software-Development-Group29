...
def view_products():
    ...
    return render_template('view_products.html', products_list=products_list, user_id=user_id)
...
def my_products():
    ...
    return render_template('my_products.html', products_list=products_list, user_id=user_id)
...
def delete_product(product_id):
    ...
    cursor.execute("SELECT * FROM Products WHERE product_id = ? AND user_id = ?", (product_id, user_id))
